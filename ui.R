shinyUI(navbarPage("CMS Neediness Index",
        ...
        tabPanel("Welcome",
                 ...
                 mainPanel(width = 11,
                           ...
                           h5("This School Neediness Index Map identifies which among 
                              ...
                              by the School Effectiveness Division (SED).", align = "justify"),
                           ...
                           img(src='ansa_logo.png', align = "left", height = 100, width = 350),
        ...
        tabPanel("School Neediness Index Methodology",
        ...
        tabPanel("School Neediness Index Map",
                 ...
                 sidebarLayout(
                     ...
                     mainPanel(
                               ...
                               leafletOutput("map", width = 825, height = 850)
                 ...
                 sidebarLayout(
                               ...
                               sidebarPanel(width = 3,
                                ...
                                mainPanel(
                                          ...
                                          fluidRow(
                                                   column(5, style = "background-color: #DCDCDC; border-radius: 5px",#style = "border-color: #DCDCDC; border: 2px dashed blue; border-radius: 5px;",

                                                          h4("School Neediness Index Data"),
                                                   ...
                                                   column(5, style = "border: 2px solid #DCDCDC; border-radius: 5px;",

                                                          h4("SNI Data Visualization"),

                                                            selectInput('profle_hist_var', 'Choose Variable to Plot', choices = vars),
                                ...
                                hr(),
                                         ...
                                         fluidRow(
                                                  ...
                                                  column(5, style = "background-color: #DCDCDC; border-radius: 5px",

                                                         h4(strong("Basic School Data")),#, style="color:red"),
                                                  ...
                                                  column(5, h4(strong("Male to Female Student Ratio")), style = "border: 2px solid #DCDCDC; border-radius: 5px;",
